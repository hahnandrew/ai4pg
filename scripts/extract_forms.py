...
# The original text from the certificate would go here. This is just a sample of the top part.
original_text = extracted_text

# Running our function with the original text
json_object = parse_certificate_data(original_text)
print(json_object)
